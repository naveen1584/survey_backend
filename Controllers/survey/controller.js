...
class SurveyController extends BaseController {
    ...
    async deleteSurvey(req, res) {
        ...
        try {
            ...
            const deleteSurveyQry = `DELETE FROM survey WHERE surveyID = '${surveyID}'`;
            const deleteRes = await DBSequelize.query(deleteSurveyQry, {
                type: Sequelize.QueryTypes.DELETE
            });
            const deleteQuestionQry = `DELETE FROM surveyquestion WHERE surveyID = '${surveyID}'`;
            const deleteQuestionRes = await DBSequelize.query(deleteQuestionQry, {
                type: Sequelize.QueryTypes.DELETE
            });
            const deleteOptionQry = `DELETE FROM surveydetail WHERE surveyID = '${surveyID}'`;
            const deleteOptionRes = await DBSequelize.query(deleteOptionQry, {
                type: Sequelize.QueryTypes.DELETE
            });
            return Response(res)({
